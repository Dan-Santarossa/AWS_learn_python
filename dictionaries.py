...
#It uses a key as an identifier and a value to store the information. For example, 
...
#The key is a string providing an identifier and the value can be the same kind of values you would store in a variable.
...
#or if you are going to be adding the contents of the dictionary later, 
#you can declare an empty dictionary. You can create an empty dictionary in two ways:
...
#You provide the new value after the = sign.
#Try the following:

user["family_name"] = "Santi"
print(user)
...
###Summary
#A dictionary, like a variable can contain other data types, including other dictionaries and lists. 
#{}`. You will use dictionaries a lot in AWS as input and outputs.
