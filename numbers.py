...
#print(sentence + my_int) <<< will fail see error below
#TypeError: can only concatenate str (not "int") to str

#TypeErrors are very common when you are learning python. Python is telling you that you are trying to use a data type that will not work. 
#In this case you cannot add a string and a number together.
